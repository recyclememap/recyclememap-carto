...
@grass: #eceddf;        // Lch(90,32,128) also grassland, meadow, village_green, garden, allotments
@scrub: #eceddf;        // Lch(84,24,122)
@forest: #eceddf;       // Lch(80,30,135)
@forest-text: #46673b;  // Lch(40,30,135)
@park: #cce8ce;         // Lch(94,30,145)
@allotments: #c9e1bf;   // Lch(87,20,135)
@orchard: #eceddf; // also vineyard, plant_nursery
...
@built-up-z12: #dddddd;
@residential: #f0f1f2;      // Lch(89,0,0)
@residential-line: #b9b9b9; // Lch(75,0,0)
@retail: #ffd6d1;           // Lch(89,16,30)
@retail-line: #d99c95;      // Lch(70,25,30)
@commercial: #f2dad9;       // Lch(89,8.5,25)
@commercial-line: #d1b2b0;  // Lch(75,12,25)
@industrial: #f7fafc;       // Lch(89,9,330) (Also used for railway, wastewater_plant)
@industrial-line: #c6b3c3;  // Lch(75,11,330) (Also used for railway-line, wastewater_plant-line)
@farmland: #eceddf;         // Lch(94,14,112)
...
@cemetery: #c7d6c9; // also grave_yard
@construction: #f0f1f2; // also brownfield
@heath: #d6d99f;
...
@sand: #f0f1f2;
@societal_amenities: #f0f1f2;   // Lch(99,13,109)
@tourism: #660033;
@quarry: #c5c3c3;
@military: #f55;
@beach: #faf1cf;
...
@pitch: #c1dbd1;           // Lch(83,35,166) also track
@track: @pitch;
